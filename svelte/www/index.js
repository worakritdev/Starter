...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-652104df.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-652104df.js", "/./_app/chunks/vendor-c0ade6c6.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "tailwind.css", "size": 14077, "type": "text/css" }],
  ...
  routes: [
    ...
    },
    {
      ...
      a: ["src/routes/__layout.svelte", "src/routes/user/[uid].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/user/[uid].svelte": () => Promise.resolve().then(function() {
    return _uid_;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-82f3ca3f.js", "css": [], "js": ["/./_app/pages/__layout.svelte-82f3ca3f.js", "/./_app/chunks/vendor-c0ade6c6.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-6cd0cba4.js", "css": [], "js": ["/./_app/error.svelte-6cd0cba4.js", "/./_app/chunks/vendor-c0ade6c6.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-2655d3ca.js", "css": ["/./_app/assets/pages/index.svelte-47cdb04b.css"], "js": ["/./_app/pages/index.svelte-2655d3ca.js", "/./_app/chunks/vendor-c0ade6c6.js"], "styles": null }, "src/routes/blogs/index.svelte": { "entry": "/./_app/pages/blogs/index.svelte-6695f9c8.js", "css": [], "js": ["/./_app/pages/blogs/index.svelte-6695f9c8.js", "/./_app/chunks/vendor-c0ade6c6.js", "/./_app/chunks/Env-28e3fc40.js"], "styles": null }, "src/routes/blogs/[id].svelte": { "entry": "/./_app/pages/blogs/[id].svelte-e06b8912.js", "css": [], "js": ["/./_app/pages/blogs/[id].svelte-e06b8912.js", "/./_app/chunks/vendor-c0ade6c6.js", "/./_app/chunks/Env-28e3fc40.js"], "styles": null }, "src/routes/user/[uid].svelte": { "entry": "/./_app/pages/user/[uid].svelte-1b761b3a.js", "css": [], "js": ["/./_app/pages/user/[uid].svelte-1b761b3a.js", "/./_app/chunks/vendor-c0ade6c6.js"], "styles": null } };
...
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<ion-split-pane content-id="${"menu-content"}" when="${"lg"}"><ion-menu content-id="${"menu-content"}" side="${"start"}" type="${"overlay"}" style="${"--side-width:170px"}"><ion-header><ion-toolbar color="${"tertiary"}"><ion-title>Awesome avocado menu</ion-title></ion-toolbar></ion-header>
      <ion-content>Awesome avocado content </ion-content></ion-menu>
    <ion-content id="${"menu-content"}"><ion-header><ion-toolbar><nav class="${"bg-indigo-200 py-auto p-4"}"><a href="${"/"}">Home</a>
            <a href="${"/blogs"}">Blogs</a></nav></ion-toolbar></ion-header>
...
var css = {
  code: ".hidden.svelte-7s0s4f{display:none}",
  map: `{"version":3,"file":"Login.svelte","sources":["Login.svelte"],"sourcesContent":["<script>\\r\\n  let isLogin = false;\\r\\n<\/script>\\r\\n\\r\\n<ion-chip color=\\"tertiary\\" mode=\\"ios\\" outline=\\"true\\">\\r\\n  <ion-icon name={isLogin?'log-out':'log-in'} />\\r\\n</ion-chip>\\r\\n<div class={isLogin ? \\"hidden\\" : \\"block\\"}>\\r\\n  <form >\\r\\n    <ion-card>\\r\\n      <ion-item>\\r\\n        <ion-label position=\\"floating\\">Username</ion-label>\\r\\n        <ion-input type=\\"text\\" />\\r\\n      </ion-item>\\r\\n      <ion-item>\\r\\n        <ion-label position=\\"floating\\"\\r\\n          >Password <ion-text color=\\"danger\\">*</ion-text></ion-label\\r\\n        >\\r\\n        <ion-input required type=\\"password\\" />\\r\\n      </ion-item>\\r\\n      <button class=\\"focus:outline-none\\">\\r\\n        <ion-button type=\\"submit\\" fill=\\"solid\\" shape=\\"round\\" color=\\"tertiary\\">\\r\\n          Login\\r\\n        </ion-button>\\r\\n      </button>\\r\\n    </ion-card>\\r\\n  </form>\\r\\n</div>\\r\\n\\r\\n<!-- markup (zero or more items) goes here -->\\r\\n<style>\\r\\n  .hidden {\\r\\n    display: none;\\r\\n  }\\r\\n  /* your styles go here */\\r\\n</style>\\r\\n"],"names":[],"mappings":"AA+BE,OAAO,cAAC,CAAC,AACP,OAAO,CAAE,IAAI,AACf,CAAC"}`
};
var Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<ion-chip color="${"tertiary"}" mode="${"ios"}" outline="${"true"}"><ion-icon${add_attribute("name", "log-in", 0)}></ion-icon></ion-chip>
<div class="${escape2(null_to_empty("block")) + " svelte-7s0s4f"}"><form><ion-card><ion-item><ion-label position="${"floating"}">Username</ion-label>
        <ion-input type="${"text"}"></ion-input></ion-item>
      <ion-item><ion-label position="${"floating"}">Password <ion-text color="${"danger"}">*</ion-text></ion-label>
        <ion-input required type="${"password"}"></ion-input></ion-item>
      <button class="${"focus:outline-none"}"><ion-button type="${"submit"}" fill="${"solid"}" shape="${"round"}" color="${"tertiary"}">Login
        </ion-button></button></ion-card></form></div>
...
var Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { blog } = $$props;
  let { title, content, url, id, _id, likes, comments } = blog;
  if ($$props.blog === void 0 && $$bindings.blog && blog !== void 0)
    $$bindings.blog(blog);
  return `<ion-card style="${"display:flex;flex-direction: column;justify-content: space-between;max-height:300px;"}"><ion-card-header><ion-card-subtitle><a${add_attribute("href", url, 0)}>${escape2(url)}</a></ion-card-subtitle>
    <ion-card-title>${escape2(title)}</ion-card-title></ion-card-header>
  <ion-card-content>${escape2(content)}</ion-card-content>

  <ion-card-footer><ion-chip color="${"danger"}" mode="${"ios"}" outline="${"true"}"><ion-label>${escape2(likes || 0)}</ion-label>
      <ion-icon name="${"heart"}"></ion-icon></ion-chip>
    <ion-chip color="${"primary"}" mode="${"ios"}" outline="${"true"}"><ion-label>${escape2(comments || 0)}</ion-label>
      <ion-icon name="${"chatbox"}"></ion-icon></ion-chip>
    <a href="${"blogs/" + escape2(_id)}"><ion-chip color="${"tertiary"}" mode="${"ios"}" outline="${"true"}"><ion-label></ion-label>
        <ion-icon name="${"cube"}"></ion-icon></ion-chip></a></ion-card-footer></ion-card>`;
});
async function load$1({ fetch: fetch3 }) {
  const res = await fetch3(`${API}/blogs`);
...
var Blogs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"grid lg:grid-cols-3 mx-auto md:grid-cols-2"}">${each(blogs, (blog) => `${validate_component(Card, "Card").$$render($$result, { blog }, {}, {})}`)}</div>
...
async function load({ fetch: fetch3, page: page2 }) {
  const res = await fetch3(`${API}${page2.path}`);
...
var U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.blog === void 0 && $$bindings.blog && blog !== void 0)
    $$bindings.blog(blog);
  $$unsubscribe_page();
  return `${escape2(JSON.stringify(blog))}
${escape2(id)}
<ion-header><ion-toolbar><ion-title>${escape2(blog.title)}</ion-title></ion-toolbar></ion-header>
